  ...
  return (
    <>
      <SEO 
        ...
        description="Learn how WorkChief collects, uses, and protects your personal information. Our privacy policy explains data handling practices for our AI-powered operations management platform."
        keywords="privacy policy, data protection, GDPR, personal information, WorkChief privacy"
        canonical="https://workchief.ai/privacy-policy"
      />
      ...
      <main className="container mx-auto px-3 sm:px-4 py-6 sm:py-12 max-w-4xl">
        <div className="bg-card rounded-xl border border-border p-4 sm:p-8 md:p-12 shadow-lg">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-foreground">Privacy Policy</h1>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 sm:space-y-8">
            ...
            <section>
              ...
              <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">We may collect the following categories of data:</p>
              
              <h3 className="text-lg sm:text-xl font-medium text-foreground mb-2 sm:mb-3">A. Information You Provide</h3>
              ...
              <h3 className="text-lg sm:text-xl font-medium text-foreground mb-2 sm:mb-3 mt-4 sm:mt-6">B. Automatically Collected Information</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 ml-2 sm:ml-4">
              ...
              <h3 className="text-lg sm:text-xl font-medium text-foreground mb-2 sm:mb-3 mt-4 sm:mt-6">C. Business Data</h3>
              <p className="text-sm sm:text-base text-muted-foreground ml-2 sm:ml-4">
              ...
              <h3 className="text-lg sm:text-xl font-medium text-foreground mb-2 sm:mb-3 mt-4 sm:mt-6">D. AI Data Processing</h3>
              <p className="text-sm sm:text-base text-muted-foreground ml-2 sm:ml-4">
            ...
            <section>
              ...
              <p className="text-sm sm:text-base text-muted-foreground mb-2">We use your information to:</p>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 ml-2 sm:ml-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">3. Data Ownership</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-2"><strong>You retain ownership of:</strong></p>
              ...
              <p className="text-sm sm:text-base text-muted-foreground mb-2"><strong>WorkChief retains ownership of:</strong></p>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 ml-2 sm:ml-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">4. Data Sharing</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-2">We may share data only with:</p>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 ml-2 sm:ml-4 mb-3 sm:mb-4">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">We do not share customer data for marketing without permission.</p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">5. Data Security</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-2">We use industry-grade safeguards:</p>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 ml-2 sm:ml-4 mb-3 sm:mb-4">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">If a breach occurs, you will be notified within legally required timelines.</p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">6. Retention & Deletion</h2>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 ml-2 sm:ml-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">7. International Transfers</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">8. Cookies & Tracking</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-2">We use cookies for:</p>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 ml-2 sm:ml-4 mb-3 sm:mb-4">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">You can opt out via your browser settings. Some features may not function without cookies.</p>
            </section>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">10. Your Rights</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-2">Depending on your jurisdiction (e.g., GDPR, CCPA), you may have rights to:</p>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 ml-2 sm:ml-4 mb-3 sm:mb-4">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">Contact: <a href="mailto:support@workchief.ai" className="text-primary hover:underline">support@workchief.ai</a></p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">11. Updates</h2>
              <p className="text-sm sm:text-base text-muted-foreground">
